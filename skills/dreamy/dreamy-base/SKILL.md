---
name: dreamy-base
description: Use Dreamy base package knowledge for foundation package presence, compatibility gates, and baseline project integration decisions.
---
...
Route baseline Dreamy package facts without inventing APIs or treating template habits as immutable product law.
...
Manifest/lock -> compatibility entry -> verified capability -> project integration point -> compile/test evidence.
...
- If package version is unknown, inspect manifest and compatibility first.
- If a capability is drifted or unsupported, mark it as a blocker or assumption.
- If the behavior is domain-specific, switch to the narrower Dreamy skill.
...
- Separate observed facts, intended contracts, and unresolved hypotheses.
- Prefer compatibility records over README prose.

## Anti-patterns

- Do not claim a Dreamy API from memory.
- Do not use base as a dumping ground for UI, assets, save, or gameplay rules.
