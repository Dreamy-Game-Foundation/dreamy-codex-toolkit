---
name: dreamy-mobile
description: Apply Dreamy project defaults to Android, iOS, profiling, memory, size, and store release tasks.
---
...
Apply Dreamy project defaults to Android, iOS, profiling, memory, size, and store release tasks.
