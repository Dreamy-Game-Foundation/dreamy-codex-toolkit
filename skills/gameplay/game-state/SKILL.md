---
name: game-state
description: Use for game state gameplay implementation and verification.
---
...
Guide game state implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
