---
name: gameplay-loop
description: Implement or review Unity gameplay core loop progression, start/end conditions, waves, objectives, rewards, retry, and session cleanup.
---
...
Guide core loop progression, start/end conditions, waves, objectives, rewards, retry, and session cleanup with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
SessionStart -> Objective/Wave -> Progress -> EndCondition -> RewardTransaction -> Cleanup.
...
- Reward only after confirmed end condition.
- Session cleanup owns spawned runtime objects.
...
- Loop UI grants rewards.
- Restart leaves old timers/spawns.
