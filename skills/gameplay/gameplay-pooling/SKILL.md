---
name: gameplay-pooling
description: Implement or review Unity gameplay pool creation, spawn/despawn ownership, reset contracts, capacity, prewarm, and pooled lifecycle cleanup.
---
...
Guide pool creation, spawn/despawn ownership, reset contracts, capacity, prewarm, and pooled lifecycle cleanup with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
PoolOwner -> Prewarm -> Rent/Initialize -> ActiveUse -> DespawnReset -> Return -> Dispose.
...
- Object returns to same pool.
- Reset async/tween/event/runtime state on despawn.
...
- Destroy instead of despawn.
- Pool tiny rare objects without evidence.
