---
name: interaction
description: Implement or review Unity gameplay raycasts, target filters, layers, prompts, interact intent, distance checks, cooldowns, and ownership of interaction results.
---
...
Guide raycasts, target filters, layers, prompts, interact intent, distance checks, cooldowns, and ownership of interaction results with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
InputIntent -> Query/Filter -> Candidate -> Eligibility -> InteractionRequest -> OwnerAction -> Feedback.
...
- Use layer masks/faction/eligibility filters.
- Interactor sends intent; target owner performs action.
...
- All colliders interactable.
- Prompt owns gameplay action.
