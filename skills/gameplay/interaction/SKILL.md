---
name: interaction
description: Use for interaction gameplay implementation and verification.
---
...
Guide interaction implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
