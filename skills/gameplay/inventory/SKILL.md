---
name: inventory
description: Use for inventory gameplay implementation and verification.
---
...
Guide inventory implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
