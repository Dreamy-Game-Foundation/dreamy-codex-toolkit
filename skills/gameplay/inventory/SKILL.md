---
name: inventory
description: Implement or review Unity gameplay inventory items, stable IDs, stack rules, capacity, equip/unequip, grants, persistence, and UI rendering.
---
...
Guide inventory items, stable IDs, stack rules, capacity, equip/unequip, grants, persistence, and UI rendering with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
ItemDefinition -> ItemInstance/Stack -> InventoryTransaction -> Persist -> UIRender.
...
- Definitions in DataConfig; owned items in Datasave.
- Persist stable IDs and quantities.
...
- Save Unity object references.
- UI item mutates inventory directly.
