---
name: level-system
description: Implement or review Unity gameplay XP, levels, thresholds, rewards, unlocks, scaling curves, progression persistence, and UI updates.
---
...
Guide XP, levels, thresholds, rewards, unlocks, scaling curves, progression persistence, and UI updates with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
LevelCurve -> XPGrant -> LevelUpCheck -> Reward/Unlock -> Persist -> Feedback/UI.
...
- Curves in DataConfig; XP/current level in Datasave.
- Level-up rewards are transactional.
