---
name: level-system
description: Use for level system gameplay implementation and verification.
---
...
Guide level system implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
