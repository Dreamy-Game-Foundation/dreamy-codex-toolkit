...
description: Use for player controller gameplay implementation and verification.
---
...
Guide player controller implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
