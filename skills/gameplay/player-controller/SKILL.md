...
description: Implement or review Unity gameplay player input, movement/combat intent, camera-relative control, ability routing, mobile input, and lifecycle cleanup.
---
...
Guide player input, movement/combat intent, camera-relative control, ability routing, mobile input, and lifecycle cleanup with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
InputMap -> Intent -> ControllerState -> Motor/Ability/CombatRequest -> Feedback.
...
- Controller routes intent; motor/combat/services own behavior.
- Disable input during modal/pause/death.
...
- Controller owns all gameplay systems.
- Gameplay input active behind modal.
