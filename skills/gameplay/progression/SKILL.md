---
name: progression
description: Implement or review Unity gameplay meta progression, unlocks, quests, milestones, rewards, migration, and save/config split.
---
...
Guide meta progression, unlocks, quests, milestones, rewards, migration, and save/config split with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
ProgressDefinition -> RuntimeProgress -> Claim/UnlockTransaction -> Persist -> Analytics.
...
- Definitions in DataConfig; completed/claimed state in Datasave.
...
- Unclaimed reward lost on migration.
- Progression UI writes save directly.
