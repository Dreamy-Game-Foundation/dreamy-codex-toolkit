---
name: progression
description: Use for progression gameplay implementation and verification.
---
...
Guide progression implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
