---
name: ragdoll
description: Use for ragdoll gameplay implementation and verification.
---
...
Guide ragdoll implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
