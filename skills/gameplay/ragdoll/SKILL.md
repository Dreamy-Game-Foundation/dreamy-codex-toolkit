---
name: ragdoll
description: Implement or review Unity gameplay ragdoll activation, animator/physics handoff, colliders, pooling reset, death timing, and mobile physics cost.
---
...
Guide ragdoll activation, animator/physics handoff, colliders, pooling reset, death timing, and mobile physics cost with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
AliveAnimator -> Death/HitTrigger -> RagdollEnable -> PhysicsSettle -> Cleanup/PoolReset.
...
- Define owner of animator-to-ragdoll transition.
- Pooled ragdoll restores rigidbodies/colliders/animator.
...
- Ragdoll pooled without reset.
- Physics cost ignored on mobile.
