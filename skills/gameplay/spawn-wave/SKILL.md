---
name: spawn-wave
description: Use for spawn wave gameplay implementation and verification.
---
...
Guide spawn wave implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
