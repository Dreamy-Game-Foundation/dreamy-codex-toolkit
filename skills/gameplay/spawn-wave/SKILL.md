---
name: spawn-wave
description: Implement or review Unity gameplay spawn points, wave ownership, enemy budgets, pacing, cleanup, pooling, and win/loss transitions.
---
...
Guide spawn points, wave ownership, enemy budgets, pacing, cleanup, pooling, and win/loss transitions with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
WaveDefinition -> SpawnBudget -> SpawnPoint -> EnemyPool -> WaveRuntime -> Cleanup/EndCondition.
...
- Wave owner tracks spawned enemies and cleanup.
- Spawn definitions in config; live enemies runtime-owned.
...
- Wave ends without despawning children.
- Spawn point owns global difficulty.
