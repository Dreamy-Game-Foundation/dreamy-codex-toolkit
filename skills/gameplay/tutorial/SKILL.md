---
name: tutorial
description: Use for tutorial gameplay implementation and verification.
---
...
Guide tutorial implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
