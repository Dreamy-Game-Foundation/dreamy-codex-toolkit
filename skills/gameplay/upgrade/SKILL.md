---
name: upgrade
description: Use for upgrade gameplay implementation and verification.
---
...
Guide upgrade implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
