---
name: weapon
description: Implement or review Unity gameplay weapon definitions, equip state, fire rate, ammo, cooldown, projectile/spawn ownership, upgrades, and feedback.
---
...
Guide weapon definitions, equip state, fire rate, ammo, cooldown, projectile/spawn ownership, upgrades, and feedback with explicit config/save/runtime ownership, lifecycle cleanup, feedback boundaries, and tests.
...
WeaponDefinition -> EquipState -> FireIntent -> Cooldown/Ammo -> Attack/ProjectileRequest -> Feedback.
...
- Definition/tuning in config; owned/equipped/upgraded state in save.
- Weapon requests projectile/combat; does not own target health.
...
- Weapon VFX applies damage.
- Ammo/cooldown owner unclear.
