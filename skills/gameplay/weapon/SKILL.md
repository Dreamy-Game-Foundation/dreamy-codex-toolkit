---
name: weapon
description: Use for weapon gameplay implementation and verification.
---
...
Guide weapon implementation with clear ownership, deterministic state, save/config separation, feedback hooks, and tests.
