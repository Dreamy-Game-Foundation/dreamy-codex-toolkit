...
description: Use for mobile game analytics systems, ownership, transactions, UI binding, save, and verification.
---
...
Guide mobile game analytics systems with config ownership, persistent state, transaction safety, analytics boundaries, and fallback behavior.
