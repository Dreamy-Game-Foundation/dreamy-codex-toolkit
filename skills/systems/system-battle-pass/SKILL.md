...
description: Use for mobile game battle pass systems, ownership, transactions, UI binding, save, and verification.
---
...
Guide mobile game battle pass systems with config ownership, persistent state, transaction safety, analytics boundaries, and fallback behavior.
