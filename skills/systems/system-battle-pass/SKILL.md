---
name: system-battle-pass
description: Implement or review mobile game system behavior for battle pass seasons, XP, tiers, premium/free tracks, expiry, claims, migration, and analytics.
---
...
Guide battle pass seasons, XP, tiers, premium/free tracks, expiry, claims, migration, and analytics with transaction safety, persistence, UI boundaries, lifecycle cleanup, and analytics ordering.
...
SeasonDefinition -> XPGrant -> TierUnlock -> ClaimTransaction -> Expiry/Migration -> Persist.
...
- Season definitions in config.
- Claimed tiers/premium ownership in save.
- Expiry behavior explicit.
