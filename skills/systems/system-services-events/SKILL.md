---
name: system-services-events
description: Implement or review mobile game system behavior for service registration, event contracts, cross-feature notifications, subscription lifetime, disposal, and event bus boundaries.
---
...
Guide service registration, event contracts, cross-feature notifications, subscription lifetime, disposal, and event bus boundaries with transaction safety, persistence, UI boundaries, lifecycle cleanup, and analytics ordering.
...
ServiceDefinition -> Register -> ResolveAtRoot -> EventDefinition -> Subscribe -> Publish -> Unsubscribe/Dispose.
...
- Register before consumers resolve.
- Events have owner and payload contract.
- Subscribers clean up symmetrically.
...
- Anonymous subscriptions leak.
- Event bus replaces direct owner call.
