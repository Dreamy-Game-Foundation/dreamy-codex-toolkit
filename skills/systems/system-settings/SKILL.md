...
description: Implement or review mobile game system behavior for settings persistence, runtime application, audio/graphics/input preferences, defaults, reset, and platform constraints.
---
...
Guide settings persistence, runtime application, audio/graphics/input preferences, defaults, reset, and platform constraints with transaction safety, persistence, UI boundaries, lifecycle cleanup, and analytics ordering.
...
SettingDefinition -> LoadDefault/Save -> ApplyRuntime -> UIBinding -> Persist -> Reset/Migration.
...
- Persist preference and apply runtime effect separately.
- Settings changes debounce/save intentionally.
- Platform-specific settings guarded.
...
- Save alone changes runtime.
- Settings UI owns platform SDK.
