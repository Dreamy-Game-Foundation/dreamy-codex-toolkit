---
name: thirdparty-newtonsoft
description: Use Newtonsoft JSON serialization in Unity, converters, settings, save compatibility, Unity types, versioning, and security limits with explicit Unity lifecycle, version detection, ownership, and verification.
---

# Thirdparty Newtonsoft

## Purpose

Guide Newtonsoft JSON serialization in Unity, converters, settings, save compatibility, Unity types, versioning, and security limits without assuming absent packages or hiding lifecycle/handle ownership.
...
DTO -> JsonSerializerSettings -> ConverterPolicy -> Serialize/Deserialize -> Migration/Validation -> ErrorHandling.
...
- Use DTOs/stable IDs for saves.
- Settings/converters owned centrally.
- Unknown/future fields policy explicit.
...
- Deserialize untrusted polymorphic types blindly.
