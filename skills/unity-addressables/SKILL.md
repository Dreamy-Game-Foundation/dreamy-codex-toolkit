...
description: Use for Addressables groups, labels, profiles, catalogs, handles, release, dependencies, download size, and content update.
---
...
Addressables groups, labels, profiles, catalogs, handles, release, dependencies, download size, and content update.
