...
description: Use Unity Animator, animation clips/events, root motion, state machines, parameter hashes, transitions, and gameplay authority boundaries with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity Animator, animation clips/events, root motion, state machines, parameter hashes, transitions, and gameplay authority boundaries for Unity projects.
...
AnimationState -> Parameter/Trigger -> Transition -> EventTiming -> DomainRequest -> Cleanup.
...
- Centralize parameter hashes/constants.
- Animation event signals timing only.
- Root motion authority explicit.
...
- Animation owns gameplay state.
- Scattered string parameters.
