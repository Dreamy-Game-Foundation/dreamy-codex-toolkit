---
name: unity-async
description: Use Unity async ownership for Tasks, UniTask, coroutines, callbacks, cancellation, exceptions, owner destruction, and UI close paths with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity async ownership for Tasks, UniTask, coroutines, callbacks, cancellation, exceptions, owner destruction, and UI close paths for Unity projects.
...
Owner -> AsyncOperation -> Cancellation -> Await/Callback -> OwnerValidity -> Result/Cleanup.
...
- Every async operation has owner.
- Cancellation expected on destroy/close.
- Observe exceptions.
...
- async void gameplay flow.
- Mutate destroyed object after await.
