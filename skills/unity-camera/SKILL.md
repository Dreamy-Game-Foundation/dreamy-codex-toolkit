---
name: unity-camera
description: Use Unity camera composition, aspect ratios, follow/target ownership, shake, priority/blend, Cinemachine routing, and mobile framing with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity camera composition, aspect ratios, follow/target ownership, shake, priority/blend, Cinemachine routing, and mobile framing for Unity projects.
...
CameraOwner -> Target/Framing -> Priority/Blend -> FeedbackShake -> AspectVerification.
...
- Camera feedback does not own gameplay.
- Priority conflicts have owner.
...
- Frame only one aspect.
- Shake mutates game state.
