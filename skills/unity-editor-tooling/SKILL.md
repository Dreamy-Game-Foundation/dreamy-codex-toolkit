...
description: Use Unity editor tooling, menu items, importers, batchmode, dry-run, asset mutation, undo, dirty/save, and runtime/editor separation with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity editor tooling, menu items, importers, batchmode, dry-run, asset mutation, undo, dirty/save, and runtime/editor separation for Unity projects.
...
EditorCommand -> DryRun -> Asset/SceneOwner -> Undo/Dirty -> Save/Refresh -> Console.
...
- Editor code in Editor assemblies.
