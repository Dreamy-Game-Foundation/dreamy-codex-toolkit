...
description: Use Unity project foundations: manifests, asmdefs, folders, lifecycle, serialization, editor/runtime split, and verification loop with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity project foundations: manifests, asmdefs, folders, lifecycle, serialization, editor/runtime split, and verification loop for Unity projects.
...
ProjectRoot -> Manifest/Lock -> Asmdefs -> Runtime/EditorBoundary -> Compile/Console/Test.
...
- Runtime never references Editor.
- Inspect local project conventions first.
- Compile/console evidence after C# edits.
...
- Inspect project settings/assets before mutation.
- Keep authoring asset, runtime owner, and platform budget separate.

## Anti-patterns

- Ignore AGENTS.md.
- Claim Unity behavior without version/project inspection.
...
- Use `references/unity-implementation-invariants.md` before implementing MonoBehaviour, serialization, async, event, pooling, or UI lifecycle changes.
