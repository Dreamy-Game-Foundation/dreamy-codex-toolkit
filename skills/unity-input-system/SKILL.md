...
description: Use for Input Actions, action maps, PlayerInput, UI input, touch, gamepad, rebinding, and modal map switching.
---
...
Input Actions, action maps, PlayerInput, UI input, touch, gamepad, rebinding, and modal map switching.
