---
name: unity-material
description: Use for Unity materials, shared material mutation safety, instancing, property blocks, atlases, and runtime tinting.
---
...
Guide materials, shared material mutation safety, instancing, property blocks, atlases, and runtime tinting with explicit ownership, measurable performance, mobile constraints, and safe Unity asset handling.
...
Material/Shader -> Renderer -> Shared/Instance/PropertyBlock -> Runtime Mutation -> Batching/Memory Impact.
