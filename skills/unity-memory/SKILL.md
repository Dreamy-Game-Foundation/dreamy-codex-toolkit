---
name: unity-memory
description: Use for Memory Profiler, managed heap, native objects, textures, audio, meshes, Addressables, pools, leaks, and retained references.
---
...
Memory Profiler, managed heap, native objects, textures, audio, meshes, Addressables, pools, leaks, and retained references.
