---
name: unity-memory
description: Use Unity memory, GC allocations, managed/native heap, texture/audio memory, Addressables bundles, object lifetime, and profiling evidence with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity memory, GC allocations, managed/native heap, texture/audio memory, Addressables bundles, object lifetime, and profiling evidence for Unity projects.
...
Budget -> Capture -> Allocation/Retainer -> Owner -> Fix -> BeforeAfterCapture.
...
- Texture/audio/import settings affect memory.
- Release does not free retained references.
...
- Cache forever.
- Claim memory fix without capture.
