...
description: Use for Unity NavMesh, agents, obstacles, links, runtime baking boundaries, and AI path cost.
---
...
Guide NavMesh, agents, obstacles, links, runtime baking boundaries, and AI path cost with explicit ownership, measurable performance, mobile constraints, and safe Unity asset handling.
