...
description: Use for Unity ParticleSystem modules, pooling, overdraw, collision cost, sub emitters, and mobile budgets.
---
...
Guide ParticleSystem modules, pooling, overdraw, collision cost, sub emitters, and mobile budgets with explicit ownership, measurable performance, mobile constraints, and safe Unity asset handling.
