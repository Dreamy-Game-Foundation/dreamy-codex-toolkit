---
name: unity-physics
description: Use Unity 3D physics: Rigidbody, colliders, layers, queries, FixedUpdate, forces, triggers, continuous collision, and mobile cost with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity 3D physics: Rigidbody, colliders, layers, queries, FixedUpdate, forces, triggers, continuous collision, and mobile cost for Unity projects.
...
Intent -> Rigidbody/Collider -> FixedStep -> Query/Trigger -> CollisionResponse -> Cleanup.
...
- Forces in fixed-step.
- Use layer masks.
- Profile expensive dynamic colliders.
...
- Apply physics forces in Update.
- Many dynamic mesh colliders on mobile.
