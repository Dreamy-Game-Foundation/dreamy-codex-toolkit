...
description: Use for Rigidbody2D, Collider2D, Physics2D queries, composite/tilemap colliders, joints, and contact filters.
---
...
Rigidbody2D, Collider2D, Physics2D queries, composite/tilemap colliders, joints, and contact filters.
