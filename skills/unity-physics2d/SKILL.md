---
name: unity-physics2d
description: Use Unity 2D physics: Rigidbody2D, Collider2D, TilemapCollider2D, CompositeCollider2D, layers, queries, and fixed-step behavior with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity 2D physics: Rigidbody2D, Collider2D, TilemapCollider2D, CompositeCollider2D, layers, queries, and fixed-step behavior for Unity projects.
...
Intent -> Rigidbody2D/Collider2D -> FixedStep -> Query/Contact -> Response.
...
- Evaluate CompositeCollider2D for tilemaps.
- Use layer/contact filters.
- Fixed-step for physics movement.
...
- Many tilemap colliders without composite strategy.
- Transform moves fighting Rigidbody2D.
