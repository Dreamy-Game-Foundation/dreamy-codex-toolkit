...
description: Use for Profiler workflow for baseline, capture, CPU timeline, GC alloc, render thread, physics, scripts, and before/after comparison.
---
...
Profiler workflow for baseline, capture, CPU timeline, GC alloc, render thread, physics, scripts, and before/after comparison.
