...
description: Use for Unity frame rendering ownership, render pipeline choice, batching, overdraw, lighting, and platform budget.
---
...
Guide frame rendering ownership, render pipeline choice, batching, overdraw, lighting, and platform budget with explicit ownership, measurable performance, mobile constraints, and safe Unity asset handling.
...
RenderPipeline/Quality -> Camera/Light/Material/Shader -> Draw/Batch/Overdraw -> Profile Evidence.
