---
name: unity-scene-prefab
description: Use safe Unity scene, prefab, variant, nested prefab, override, component, and serialized reference mutation with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide safe Unity scene, prefab, variant, nested prefab, override, component, and serialized reference mutation for Unity projects.
...
Hierarchy -> PrefabOwner -> Variant/NestedContext -> Overrides -> References -> Mutation -> Save/Reopen.
...
- Inspect owner and overrides before mutation.
- Prefer editor-supported changes.
- Save only intended asset/scene.
