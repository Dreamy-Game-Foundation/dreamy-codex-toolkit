...
description: Use Unity serialization safety for fields, types, ScriptableObjects, SerializeReference, prefabs, scenes, meta GUIDs, and migrations with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity serialization safety for fields, types, ScriptableObjects, SerializeReference, prefabs, scenes, meta GUIDs, and migrations for Unity projects.
...
SerializedOwner -> Field/TypeChange -> Preservation/Migration -> AssetFixture -> Compile/LoadVerify.
...
- FormerlySerializedAs for compatible field rename.
- Preserve .meta GUIDs.
...
- Assume compile preserves data.
- Delete/recreate asset as rename.
