---
name: unity-ui
description: Use Unity UI canvases, layout, EventSystem, raycasts, safe area, TMP, dynamic lists, panel lifecycle, transitions, and mobile input with Unity-safe ownership, serialized asset safety, and verification evidence.
---
...
Guide Unity UI canvases, layout, EventSystem, raycasts, safe area, TMP, dynamic lists, panel lifecycle, transitions, and mobile input for Unity projects.
...
Canvas -> Layout -> Binding -> Input/Raycast -> StateRender -> Transition -> Cleanup.
...
- Nested ContentSizeFitter storms.
- UI owns business/save logic.
