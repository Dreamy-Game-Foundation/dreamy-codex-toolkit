---
name: unity-urp
description: Use for Unity URP renderer assets, quality levels, renderer features, post-processing, camera stacking, and mobile tradeoffs.
---
...
Guide URP renderer assets, quality levels, renderer features, post-processing, camera stacking, and mobile tradeoffs with explicit ownership, measurable performance, mobile constraints, and safe Unity asset handling.
...
URPAsset -> RendererData -> CameraStack -> Lights/Shadows/PostFX -> QualityTier -> Build/Runtime Budget.
