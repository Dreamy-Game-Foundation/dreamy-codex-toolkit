---
name: unity-vfx
description: Use for Unity VFX ownership, spawn lifetime, pooling, GPU cost, feedback events, and platform fallback.
---
...
Guide VFX ownership, spawn lifetime, pooling, GPU cost, feedback events, and platform fallback with explicit ownership, measurable performance, mobile constraints, and safe Unity asset handling.
